...
const Card = ({
  ...
  return (
    ...
    >
      <Icon className="absolute h-6 w-6 -top-3 -left-3 dark:text-white/85 text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3 dark:text-white/85 text-black" />
      <Icon className="absolute h-6 w-6 -top-3 -right-3 dark:text-white/85 text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -right-3 dark:text-white/85 text-black" />
...
const OuterIcon = ({ title }: { title: string }) => {
  return (
    <div>
